...
<head>
    ...
    <?php
        ...
        $rows = $User->getUsuarios($db);
        include STAT .'/header.php';
        ?>
</head>

<body class="no-skin">
    <?php include STAT.'/menu.php';?>
                ...
                <div class="breadcrumbs" id="breadcrumbs">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="table-header"> Usuarios conectados <div class="hidden-sm hidden-xs btn-group">
                                                        <a href="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>?do=registrar-usuario">
                                                            <button class="btn btn-xs btn-success" title="Registrar nuevo usuario"> <i class="ace-icon fa fa-plus bigger-120"></i> </button>
                                                        </a>
                                                    </div></div>
