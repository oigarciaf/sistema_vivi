...
, function (a) {
    ...
    , function (a) {
        ace.vars.VE_STATES = ["Amazonas", "Anzoategui", "Apure", "Aragua", "Barinas", "Bolivar", "Carabobo", "Cojedes", "Delta Amacuro", "Dependencias Federales", "Distrito Federal", "Falcon", "Guarico", "Lara", "Merida", "Miranda", "Monagas", "Nueva Esparta", "Purtuguesa", "Sucre", "Tachira", "Trujillo", "Vargas", "Yaracuy", "Zulia"];
        try {
            a("#nav-search-input").bs_typeahead({
                source: ace.vars.VE_STATES
                , updater: function (b) {
